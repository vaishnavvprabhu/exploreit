...
public final class FragmentListBinding implements ViewBinding {
  ...
  @NonNull
  public final ExtendedFloatingActionButton something;

  private FragmentListBinding(@NonNull ConstraintLayout rootView,
      @NonNull ExtendedFloatingActionButton something) {
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.something;
      ExtendedFloatingActionButton something = ViewBindings.findChildViewById(rootView, id);
      if (something == null) {
        break missingId;
      }

      return new FragmentListBinding((ConstraintLayout) rootView, something);
    }
